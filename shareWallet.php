    ...
    $(document).ready(function() {
        ...
        $("#paytype").on("change", function() {
            ...
            if (paytype == "auto_funding") {
                ...
                var stampduty = <?php echo $walletFundingInfo->stamp_duty_amount;?>;
        		var stampdutyLimit = <?php echo $walletFundingInfo->stamp_duty_limit;?>;
        		var amntCredit = airAmnt - stampduty;
